...
> 原文： [http://numba.pydata.org/numba-doc/latest/cuda/cudapysupported.html](http://numba.pydata.org/numba-doc/latest/cuda/cudapysupported.html)
...
支持`raise`和`assert`语句。参见 [nopython 语言支持](../reference/pysupported.html#pysupported-language)。
...
参见 [nopython 内置类型](../reference/pysupported.html#pysupported-builtin-types)。
